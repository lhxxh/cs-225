...
class HuffmanTree
{
  ...
  private:
    ...
    /* readTree helper function recursively aceess to every node by build new node according to the file*/
    void readTreehelper(TreeNode*& node,BinaryFileReader& bfile);
};
#endif
